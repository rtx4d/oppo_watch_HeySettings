.class public Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;
.super Landroid/support/wearable/activity/WearableActivity;
.source "VoicemailNumberActivity.java"
...
.method private cancelAndCleanUp()V
    ...
    .line 76
    invoke-virtual {p0}, Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;->getIntent()Landroid/content/Intent;
    ...
    .line 81
    :cond_0
    invoke-virtual {p0, v2, v1}, Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;->setResult(ILandroid/content/Intent;)V

    .line 82
    return-void
.end method

.method public static synthetic lambda$verifyPhoneNumberChanged$0(Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;Ljava/lang/String;Landroid/content/DialogInterface;I)V
    .locals 4
    ...
    invoke-virtual {p0}, Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;->getApplicationContext()Landroid/content/Context;
    ...
    .line 65
    invoke-virtual {p0}, Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;->finish()V

    .line 66
    return-void
.end method

.method public static synthetic lambda$verifyPhoneNumberChanged$1(Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;Landroid/content/DialogInterface;I)V
    .locals 0
    ...
    .line 69
    invoke-direct {p0}, Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;->cancelAndCleanUp()V
...
.method private verifyPhoneNumberChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 56
    new-instance v1, Lcom/google/android/clockwork/settings/cellular/-$$Lambda$VoicemailNumberActivity$apB_hV39fKjsy3kjOedgGy9_5cw;

    invoke-direct {v1, p0, p1}, Lcom/google/android/clockwork/settings/cellular/-$$Lambda$VoicemailNumberActivity$apB_hV39fKjsy3kjOedgGy9_5cw;-><init>(Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;Ljava/lang/String;)V
    ...
    .line 67
    new-instance v1, Lcom/google/android/clockwork/settings/cellular/-$$Lambda$VoicemailNumberActivity$PfWW5RzccUWsbEocqsZvQaoiJjA;

    invoke-direct {v1, p0}, Lcom/google/android/clockwork/settings/cellular/-$$Lambda$VoicemailNumberActivity$PfWW5RzccUWsbEocqsZvQaoiJjA;-><init>(Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;->setContentView(I)V
    ...
    .line 29
    invoke-virtual {p0}, Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;->getFragmentManager()Landroid/app/FragmentManager;
...
.method public onDialPadEnd(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p2, v0}, Lcom/google/android/clockwork/settings/cellular/VoicemailNumberActivity;->verifyPhoneNumberChanged(Ljava/lang/String;Ljava/lang/String;)V
